  ...
  const services = [
    {
      ...
      description:
        "Creative direction for brands, campaigns, and digital experiences shaped with clarity, structure, and a strong point of view.",
      bullets: ["Concept", "Direction", "Campaigns"],
    },
    {
      title: "Branded Content",
      description:
        "Branded content designed to build interest, trust, and a clearer visual identity across launches, campaigns, and platforms.",
      bullets: ["Campaigns", "Launches", "Visuals"],
    },
    {
      title: "Brand Films & Video",
      description:
        "Short-form films and video content with stronger atmosphere, sharper storytelling, and a more editorial visual language.",
      bullets: ["Films", "Video", "Storytelling"],
    },
    {
      title: "Copywriting & Editorial",
      description:
        "Copy, messaging, and editorial writing that help ideas feel structured, expressive, and easier to connect with.",
      bullets: ["Copy", "Messaging", "Editorial"],
    },
    {
      title: "Website & Digital Design",
      description:
        "Website and digital design shaped for clarity, presence, and a stronger experience across interfaces and brand touchpoints.",
      bullets: ["Websites", "Digital", "Interfaces"],
    },
    {
      title: "Audio & Podcast Production",
      description:
        "Audio and podcast production that supports storytelling through cleaner structure, editing, and sound presence.",
      ...
      <main className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        <section className="mb-32 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-neutral-400">
              Creative direction, branded content, websites, launch systems, and bilingual AI-assisted
              workflows for modern brands and platforms.
            </p>
          ...
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <div className="mt-4 max-w-xl text-sm leading-7 text-neutral-400">
                Commercially strong video, social content, and visual storytelling concepts for
                launches, campaigns, and branded worlds.
              </div>
            </div>
          </div>
        ...
        <section className="mb-32 font-clean">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {previews.map((p) => (
              ...
              >
                <div
                  className={`h-52 overflow-hidden rounded-[1.6rem] border border-white/10 p-4 ${p.theme}`}
                >
                  {p.key === "boho" && (
                    <img
                      src="/images/luma.jpg"
        ...
        <section className="mb-32 font-clean">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-2">
            <a
              href="https://www.yangtheory.com/journey"
              target="_blank"
            ...
            >
              ...
              <div className="p-7">
                ...
                <div className="mt-4 text-sm leading-7 text-neutral-400">
                  A creative world spanning book, soundtrack, visual design, and short film
                  development.
                </div>
                <div className="mt-6 text-xs uppercase tracking-[0.2em] text-white/60">
                  Enter Journey →
                </div>
              </div>
            </a>
            ...
            >
              ...
              <div className="p-7">
                ...
                <div className="mt-4 text-sm leading-7 text-neutral-400">
                  The umbrella platform for original releases, concepts, and long-form creative
                  worlds.
                </div>
                <div className="mt-6 text-xs uppercase tracking-[0.2em] text-white/60">
                  Visit Platform →
        ...
        <section className="mb-32 font-clean">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-[1.8rem] border border-white/10 bg-neutral-900/70 p-7">
              ...
              <div className="mt-4 text-sm leading-7 text-neutral-400">
                A digital product concept in active development, focused on interface, utility,
                and experience.
              </div>
            </div>
          </div>
        ...
        <section className="border-t border-white/10 pt-12 font-clean">
          ...
          <div className="mt-4 text-3xl font-medium text-[#F5F1E8]">
            Open for selected projects and collaborations.
          </div>
    ...
    <div className="flex h-full flex-col justify-between">
      <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.18em] text-black/45">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#B9AA90]/40 text-[#8A7A61]">
            ✿
          </div>
          <div className="leading-none">
            <div className="font-editorial text-[1.5rem] tracking-[0.08em] text-[#3A3128] normal-case">
              Luma
            </div>
            <div className="mt-1 text-[9px] uppercase tracking-[0.42em] text-[#8A7A61]">
              Atelier
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-2 text-[10px] text-black/55">
        {["Rituals", "Skin", "Book"].map((item) => (
          <div key={item} className="rounded-full border border-black/12 px-2 py-1">
            {item}
          </div>
        ))}
      </div>
    ...
    <div className="flex h-full flex-col justify-between text-[#F3E7D4]">
      <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.18em] text-[#E8D7BE]/60">
        <div className="leading-none">
          ...
          <div className="mt-1 text-[9px] uppercase tracking-[0.34em] text-[#D2B89A]">
            Coffee & Kitchen
          </div>
        </div>
      ...
      <div className="flex gap-2 text-[10px] text-[#E8D7BE]/72">
        {["Menu", "Visit", "Story"].map((item) => (
          <div key={item} className="rounded-full border border-[#E8D7BE]/24 px-2 py-1">
            {item}
          </div>
        ))}
      </div>
    ...
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="flex gap-2 text-[10px] text-white/58">
        {["Menu", "Reserve", "Story"].map((item) => (
          <div key={item} className="rounded-full border border-white/16 px-2 py-1">
            {item}
          </div>
        ))}
      </div>
...
function BohoPreview({ onClose }) {
  return (
    <PreviewShell
      onClose={onClose}
      className="h-full overflow-y-auto bg-[#F3EEE6] text-[#2D261F] font-editorial"
    >
      <div className="mx-auto max-w-[1180px] px-6 py-8 md:px-8 md:py-10">
        <div className="flex items-center justify-between border-b border-black/5 pb-6 text-[11px] uppercase tracking-[0.16em] text-black/45">
          <div className="flex items-center gap-4">
            <div className="flex flex-col leading-none">
              <span className="font-editorial text-[2.1rem] tracking-[0.12em] text-[#3A3128]">
                Luma
              </span>
              <span className="mt-1 pl-[0.12rem] text-[10px] uppercase tracking-[0.42em] text-[#8A7A61]">
                Atelier
              </span>
            </div>
          </div>
          ...
          <button className="rounded-none bg-[#7A826B] px-6 py-4 text-[11px] tracking-[0.16em] text-[#F3EEE6]">
            Book Appointment
          </button>
        </div>
        ...
        <div className="mt-8 grid gap-7 lg:grid-cols-[1.7fr_0.78fr]">
          <div className="relative overflow-hidden bg-[#E7DED0] min-h-[620px]">
            ...
            <div className="relative flex h-full flex-col justify-end p-10 md:p-14">
              <div className="max-w-md">
                <div className="text-[11px] uppercase tracking-[0.22em] text-[#9E876A]">
          ...
          <div className="border border-[#D8CCBC] bg-[#EFE7DB] px-6 pb-8 pt-10 text-center">
            <div className="mx-auto flex h-[520px] max-w-[340px] flex-col rounded-t-[999px] border border-[#D7CABB] px-6 pb-8 pt-10">
              <div className="text-[11px] uppercase tracking-[0.22em] text-[#A08667]">
                Signature Ritual
              </div>
              <div className="mt-5 text-4xl font-light tracking-[0.08em] text-[#2B241E]">
                LUMA GLOW
              </div>
              <div className="mt-3 text-[11px] uppercase tracking-[0.22em] text-[#A08667]">
                90 Minutes
              </div>
              <img
        ...
        <div className="mt-6 grid gap-0 md:grid-cols-3">
          ...
          <div className="bg-[#EFE8E0] px-10 py-10">
            ...
            <div className="mt-7 text-5xl italic font-light leading-none text-[#8F947E]">
              Welcome. I’m Alina.
            </div>
            <p className="mt-8 max-w-sm text-[16px] leading-8 text-black/70">
              LUMA Atelier was created as a quiet space for you to slow down and come home to
              yourself. Every ritual is designed with intention.
            </p>
            <div className="mt-8 text-4xl italic text-[#7D846E]">Alina</div>
            <button className="mt-6 text-[11px] uppercase tracking-[0.18em] text-[#2D261F]">
              Our Story →
            </button>
          </div>
          <div className="flex flex-col items-center justify-center bg-[#E3DED1] px-10 py-10 text-center">
            ...
            <div className="mt-8 text-[13px] uppercase tracking-[0.18em] text-[#2D261F]">
              Well+Good
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-0 lg:grid-cols-[1.45fr_0.8fr]">
          <div className="bg-[#F7F2EB] px-10 py-12 md:px-14">
            <div className="text-center">
              <div className="text-[11px] uppercase tracking-[0.22em] text-[#A08667]">
                Rituals That Nurture
              </div>
              <h2 className="mt-4 text-5xl font-light tracking-[0.01em] text-[#2D261F]">
                Our Treatments
              </h2>
            </div>
            <div className="mt-12 grid gap-0 md:grid-cols-4">
              {[
                ...
                <div
                  key={title}
                  className="flex flex-col items-center px-6 py-4 text-center md:border-r md:border-black/8 last:md:border-r-0"
                >
                  <div className="text-3xl text-[#A58C67]">{icon}</div>
                  <div className="mt-6 text-[13px] uppercase tracking-[0.16em] text-[#2D261F]">
                    {title}
                  </div>
                  <div className="mt-5 text-sm leading-7 text-black/65">{text}</div>
                  <button className="mt-6 text-[11px] uppercase tracking-[0.16em] text-[#2D261F]">
                    Book →
                  </button>
                </div>
              ))}
        ...
        <div className="mt-6 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center text-[#F7F1E8]">
            <div className="text-6xl font-light leading-tight tracking-[0.01em]">
        ...
        <div className="grid gap-0 bg-[#7E866D] px-8 py-8 text-[#F5EFE5] md:grid-cols-[1.2fr_1fr_1fr_1.2fr_1fr] md:px-10">
          <div>
            <div className="font-editorial text-[2.2rem] tracking-[0.12em] text-[#F5EFE5]">
              Luma
            </div>
            <div className="mt-1 text-[10px] uppercase tracking-[0.42em] text-white/70">
              Atelier
            </div>
          </div>
    ...
    <PreviewShell onClose={onClose} className="h-full overflow-y-auto bg-[#f7f2ea] text-[#2c221c]">
      <div className="mx-auto max-w-[1180px] px-6 py-8 md:px-8 md:py-10">
        <div className="flex items-center justify-between py-4 text-[12px] text-[#6f5b4c]">
          ...
          <button className="rounded-full border border-[#bba893] px-5 py-2 text-[11px] uppercase tracking-[0.16em]">
            Order Ahead
          </button>
        </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
          <div className="rounded-[2rem] bg-[#e9ddcf] p-8 md:p-10">
            <div className="text-[11px] uppercase tracking-[0.2em] text-[#9a7a58]">
              Neighborhood café
            </div>
            ...
            <p className="mt-6 max-w-md text-[16px] leading-8 text-black/62">
              A warm, lived-in café brand with seasonal drinks, fresh pastries, and a room
              designed for staying awhile.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-4">
              ...
              <div className="rounded-[1.4rem] bg-[#d9c5ad] p-5">
                <div className="text-[10px] uppercase tracking-[0.18em] text-[#8a6745]">
                  Today’s special
                </div>
          ...
          <div className="grid gap-6 sm:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-[2rem] bg-[#d6b391] p-5">
                ...
                />
                <div className="mt-5 text-[11px] uppercase tracking-[0.18em] text-[#7f5e41]">
                  Signature drink
                </div>
                <div className="mt-2 font-serif text-3xl">House Latte</div>
                <div className="mt-2 text-sm leading-7 text-black/62">
                  Espresso, oat milk, maple, and cinnamon foam.
                </div>
              </div>
              <div className="rounded-[2rem] bg-[#2f241e] px-6 py-7 text-[#f7efe6]">
                ...
                <div className="mt-4 font-serif text-3xl leading-[1.2]">
                  Come for the coffee. Stay for the room.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[0.82fr_1.18fr]">
          <div className="rounded-[2rem] bg-[#efe5d9] p-8">
            ...
            <div className="mt-5 font-serif text-4xl leading-[1.08]">
              Built for warm cups, good light, and daily ritual.
            </div>
            <p className="mt-5 text-[15px] leading-8 text-black/62">
              North House was imagined as a softer kind of café. Familiar, design-led, and easy
              to return to.
            </p>
            <button className="mt-8 text-[11px] uppercase tracking-[0.18em] text-[#2c221c]">
              Read the story →
            </button>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div className="rounded-[1.8rem] bg-[#e2d4c2] p-6 flex flex-col justify-center text-center">
              ...
              <div className="mt-4 font-serif text-3xl leading-[1.25]">
                The kind of café you return to.
              </div>
              <div className="mt-6 text-[11px] uppercase tracking-[0.18em] text-[#7d6044]">
                Daily Brew Guide
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 rounded-[2.2rem] bg-[#fbf7f1] px-8 py-10 md:px-12">
          <div className="flex items-end justify-between gap-6 border-b border-black/8 pb-6">
            <div>
              <div className="text-[11px] uppercase tracking-[0.18em] text-[#9a7a58]">
                Menu highlights
              </div>
              <h2 className="mt-3 font-serif text-5xl">What’s on the table</h2>
            </div>
            <div className="hidden text-[11px] uppercase tracking-[0.18em] text-[#7f6248] md:block">
              Updated daily
            </div>
          </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.12fr_0.88fr]">
          ...
          <div className="rounded-[2rem] bg-[#7a624d] px-8 py-10 text-[#f6eee4] flex flex-col justify-between">
            <div>
              ...
              <div className="mt-4 font-serif text-5xl leading-[1.05]">
                Coffee, brunch, and a room worth staying in.
              </div>
            </div>
...
function RestaurantPreview({ onClose }) {
  return (
    <PreviewShell
      onClose={onClose}
      className="h-full overflow-y-auto bg-[#0b0b0b] text-[#EDE7DD] font-cinzel"
    >
    ...
    <PreviewShell onClose={onClose} className="bg-black text-white">
      <div className="p-10 md:p-12">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-lg text-[15px] leading-8 text-neutral-400">
              Designed to create impact from the first moment, establish tone, and define the
              visual language of a launch through atmosphere, movement, and strong image-making.
            </p>
          </div>
          ...
          <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm">
            ...
            <div className="mt-4 text-sm leading-7 text-neutral-300">
              Creates first impression, builds emotional connection, and gives a campaign a clear
              visual center across website, social, and launch materials.
            </div>
          </div>
        </div>
        ...
        <div className="relative mt-12 overflow-hidden rounded-[1.8rem] border border-white/10">
          ...
          <div className="absolute left-8 top-8 text-[10px] uppercase tracking-[0.22em] text-white/62">
            Launch visual
          </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div>
            ...
            />
            <div className="mt-3 text-[11px] uppercase tracking-[0.18em] text-white/40">
              Opening Frame
            </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-3 text-sm leading-7 text-neutral-300">
              A hero film designed to introduce a brand or product through atmosphere, rhythm, and
              visual storytelling.
            </div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-3 text-sm leading-7 text-neutral-300">
              Hero film, short edits, vertical versions, campaign stills, and launch-ready cuts for
              different platforms.
            </div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-3 text-sm leading-7 text-neutral-300">
              Developed through concept direction, AI-assisted visual creation, scripting, and
              editing focused on strong ideas rather than production scale.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-10 md:p-12">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-lg text-[15px] leading-8 text-neutral-400">
              Designed to create consistency, rhythm, and recognizability across social platforms
              while allowing variation in tone, product, and storytelling.
            </p>
          </div>
          ...
          <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm">
            <div className="text-[11px] uppercase tracking-[0.2em] text-white/45">What it does</div>
            <div className="mt-4 text-sm leading-7 text-neutral-300">
              Turns individual posts into a cohesive campaign language that can scale across drops,
              launches, and ongoing brand presence.
            </div>
          </div>
        </div>

        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <img src="/images/campaign-1.jpg" alt="Campaign social 1" className="w-full object-cover" />
          <img src="/images/campaign-2.jpg" alt="Campaign social 2" className="w-full object-cover" />
          <img src="/images/campaign-3.jpg" alt="Campaign social 3" className="w-full object-cover" />
          <img src="/images/campaign-4.jpg" alt="Campaign social 4" className="w-full object-cover" />
          <img src="/images/campaign-5.jpg" alt="Campaign social 5" className="w-full object-cover" />
          <img src="/images/campaign-6.jpg" alt="Campaign social 6" className="w-full object-cover" />
          <img src="/images/campaign-7.jpg" alt="Campaign social 7" className="w-full object-cover" />
          <img src="/images/campaign-8.jpg" alt="Campaign social 8" className="w-full object-cover" />
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-3 text-sm leading-7 text-neutral-300">
              A repeatable visual language that keeps campaigns consistent across posts, drops, and
              sequences.
            </div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-3 text-sm leading-7 text-neutral-300">
              Fashion, product, editorial, and experimental visuals adapted to different brand
              tones.
            </div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 max-w-md text-[15px] leading-8 text-white/58">
              Share what is being built, what kind of support is needed, and what kind of direction
              would make the project feel stronger, clearer, and more alive.
            </p>
            <div className="mt-10 space-y-6 text-sm leading-7 text-white/62">
              <div className="border-t border-white/10 pt-5">
                Creative direction, content, websites, film, editorial work, bilingual projects,
                and digital concepts.
              </div>
              <div className="border-t border-white/10 pt-5">
                For collaborations, commissions, campaigns, and selected long-form creative
                projects.
              </div>
              <div className="border-t border-white/10 pt-5">
                English and Turkish inquiries welcome.
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm md:p-10">
            <form
              action="mailto:hello@yangtheory.com"
              method="POST"
              encType="text/plain"
              className="grid gap-6"
            >
              <div>
                <label className="mb-2 block text-[11px] uppercase tracking-[0.18em] text-white/42">
                  Name
                </label>
                <input
                  name="name"
                  placeholder="Your name"
                  className="w-full border border-white/10 bg-black/20 px-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none"
                />
              </div>
              <div>
                <label className="mb-2 block text-[11px] uppercase tracking-[0.18em] text-white/42">
              ...
              <div>
                ...
                <input
                  name="service"
                  placeholder="Creative direction, branded content, website, copy, audio..."
                  className="w-full border border-white/10 bg-black/20 px-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none"
                />
              </div>
              <div>
                ...
                <textarea
                  name="details"
                  placeholder="Tell me what you need, the tone you want, and what would make this project successful."
                  rows={6}
                  className="w-full resize-none border border-white/10 bg-black/20 px-4 py-3 text-sm leading-7 text-white placeholder:text-white/25 focus:outline-none"
                />
              </div>
              <button
                type="submit"
                className="mt-2 self-start border border-white/18 px-8 py-4 text-[11px] uppercase tracking-[0.18em] text-white transition hover:bg-white hover:text-black"
              >
                Send Inquiry
              </button>
            </form>
    ...
    <PreviewShell onClose={onClose} className="bg-black text-white">
      <div className="p-10 md:p-12">
        ...
        <div className="mt-12 max-w-2xl">
          <h1 className="text-4xl font-light leading-tight md:text-5xl">Product Story Clip</h1>
          <p className="mt-6 leading-8 text-neutral-400">
            A refined, sensory-driven format focused on desire, material, and presence. Built to
            make a product feel elevated, intimate, and essential.
          </p>
        </div>
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <div className="pt-4">
                ...
                <p className="mt-10 max-w-xl text-[1rem] leading-8 text-white/72 md:text-[1.05rem]">
                  A future-facing landing page built around dimensional form, atmosphere, and
              ...
              {["3D Fundamentals", "Advanced Lighting", "Product Rendering"].map((c) => (
                <div key={c} className="rounded-xl border border-white/10 bg-white/5 p-6">
                  ...
                  <div className="mt-3 text-sm text-white/60">
                    High-quality structured learning for visual creators.
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="border-t border-white/10 px-10 py-20 md:px-14 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="mt-6 text-white/60 leading-8">
                Focused on clarity, tools, and visual thinking — built for people working across
                design, 3D, and digital products.
              </p>
            </div>
          </div>
